...
export default function GameScreen({ userNumber, onGameOver }) {
  ...
  function nextGuessHandler(direction) {
    if (
      ...
      Alert.alert("내 누군지 아늬", "구라치지마라", [
        { text: "구라치면 손모가지 날라간다", style: "cancel" },
      ]);
      return;
    }
    if (direction === "lower") {
  ...
  const guessRoundsListLenghth = guessRounds.length;
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.listContainer}>
        ...
        <FlatList
          ...
          renderItem={(itemData) => (
            <GuessLogItem
              roundNumber={guessRoundsListLenghth - itemData.index}
              guess={itemData.item}
            />
          )}
